...
type ServerInterface interface {
	...
	// Get file by ID
	// (GET /file/{fileID})
	GetFileFileID(w http.ResponseWriter, r *http.Request, fileID openapi_types.UUID)
}
...
// GetFileFileID operation middleware
func (siw *ServerInterfaceWrapper) GetFileFileID(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	var handler http.Handler = http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetFileFileID(w, r, fileID)
	})
...
func HandlerWithOptions(si ServerInterface, options ChiServerOptions) http.Handler {
	...
	r.Group(func(r chi.Router) {
		r.Put(options.BaseURL+"/file", wrapper.PutFile)
	})
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/file/{fileID}", wrapper.GetFileFileID)
	})
